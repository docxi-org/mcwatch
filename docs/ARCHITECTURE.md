...
| | Игр | Доля |
|---|---|---|
| Найден **подходящий** летсплей | 39 | 89% |
| …из них с субтитрами | 34 | 87% от найденных |
| …из них без субтитров | 5 | |
| Летсплей не найден вовсе | 5 | 11% |
| **Итого получат заключение** | **34** | **77%** |
...
Рабочий отсев: доля значимых слов названия игры (длиннее двух букв),
встречающихся в названии ролика, ≥ 0.6. На выборке разделяет чисто: у чужих
роликов 0%, у верных — 60–100%.
